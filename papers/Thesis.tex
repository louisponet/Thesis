...
\definecolor{mydarkblue}{rgb}{0.25, 0.0, 0.25}
% \renewcommand*{\glstextformat}[1]{\textcolor{black}{#1}}
\renewcommand*{\glstextformat}[1]{\textcolor{mydarkblue}{#1}}
