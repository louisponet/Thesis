%
\documentclass[12pt,a4paper,makeidx,oneside]{phdthesis}
...
Solving these subproblems then allows for progress to be made in understanding the physics that governs them.
