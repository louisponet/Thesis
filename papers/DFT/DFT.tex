\chapter{Density Functional Theory \label{sec:DFT}}
...
The required bridge between the two methods can be formed through Wannier functions and Wannierization, see Appendix~\ref{sec:Wannier}. 
