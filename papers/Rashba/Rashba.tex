...
############################ NEW ############################
The first effect that springs to mind bearing the signatures of the above description is the Rashba effect, first theorised in the seminal 1959 paper by Rashab and Bychkov\cite{Rashba1959Symmetry}. The standard derivation starts from the fully relativistic Dirac-equation

\begin{equation}

\end{equation}

thought one tends to have when reading the above description One well known effect that has the same signatures as has been described above of the above described 
While looking at the first While a very similar looking effect has been described 
