...
As discussed before, a purely relativistic effect would rather have a prefactor of $\alpha_R=10^{-6}$~eV.

Another hard to explain observation by purely relativistic means, is the orientation of the spin-polarization inside the different split bands.
...
This has been confirmed experimentally\cite{Krempasky2015SurfaceSemiconductor}, and can only be explained through the OAM and atomic SOC mechanism, and depends on the value of the total angular momentum $j$.
How exactly this manifests itself in our results will be discussed further down.
