...
\begin{equation}
	d_z(\bm{n}) = ae^{-\frac{a^2|\bm{n}|^2}{2}}\frac{\pi^{\frac{3}{2}}}{16\sqrt{2}}\left(\begin{matrix}0&0&0&2\\\\0&0&0&n_x\\\\0&0&0&n_y\\\\2&n_x&n_y&0\end{matrix}\right),
...
\begin{align}
	\Ket{\alpha(\bm{k})} &= \Ket{p_x} + i \frac{e E_z \sum_{\bm{n}} \sin(k_x n_x)}{E_{p_z} - E_{p_x}} \Ket{p_z}\\
	&=\Ket{p_x} + i c(\bm{k}) \Ket{p_z}.
\end{align}
