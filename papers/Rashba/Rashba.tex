...
\subsubsection{Atomic Spin-Orbit Coupling}
...
The situation in GeTe thus closely mimics the toy model we discussed in Section~\ref{sec:tb_model}, and should also harbor the unquenching effect due to atomic SOC on the heavy Te.
