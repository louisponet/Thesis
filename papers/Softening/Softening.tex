...
\section{Methods}
We are trying to compute and minimize the free energy density in Eq.~\ref{eq:BTO_energy}, which is written in terms of the values and gradients of two order parameters $P$ and $u$.
...
These can then be filled into the free energy density Eq.~\ref{eq:BTO_energy} to find the contribution of the volume inside the element to the total free energy.
