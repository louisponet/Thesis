...
\end{eqnarray}
where all coefficients are positive, $\partial_i$ signify spatial derivatives, and the indices enumerate ${x,y,z}$ with an implied summation over repeated ones.
