...
We give a short introduction into the methods we used in order to simulate phase field models such as the one defined in Chapter~\ref{ch:Softening}, Eq.~\ref{eq:BTO_energy}.
