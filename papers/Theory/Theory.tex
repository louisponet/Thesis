...
The starting point of any Tight-Binding model are the orbitals that are used as the basis-set.
In electronic problems, one often uses the valence orbitals of the constituent ions \cite{Slater1954}.
...
It can be shown that this process leads to, at least, a local minimum of the Kohn-Sham functional\ref{eq:Theory_kohnsham}.
...
We know that the eigenstates for the periodic potentials found in crystalline systems are the Bloch Functions \cite{Ashcroft}:
\begin{equation}
